...
import tik from '@/images/features/tik.png';
import indicator from '@/images/features/indicator.png';
import mark from '@/images/features/icon.png';
import person1 from '@/images/features/person1.png'
const Feature = () => {
    return (
